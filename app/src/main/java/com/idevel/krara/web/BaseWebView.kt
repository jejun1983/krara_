...
import com.idevel.krara.web.constdata.IdevelServerScript
...
class BaseWebView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : WebView(context, attrs, defStyleAttr) {
    init {
        ...
        if (com.idevel.krara.BuildConfig.DEBUG) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                setWebContentsDebuggingEnabled(com.idevel.krara.BuildConfig.DEBUG)
            }
        }
